...
namespace pro2 {
    ...
    public partial class employeesDBDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeesRow AddemployeesRow(string lastname, string birthday, string gender, string email, string name) {
...
namespace pro2.employeesDBDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `employees` WHERE ((`Id` = ?) AND ((? = 1 AND `lastname` IS NULL) OR (`lastname` = ?)) AND ((? = 1 AND `birthday` IS NULL) OR (`birthday` = ?)) AND ((? = 1 AND `gender` IS NULL) OR (`gender` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `employees` (`lastname`, `birthday`, `gender`, `email`) VALUES (?, ?," +
                " ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `employees` SET `lastname` = ?, `birthday` = ?, `gender` = ?, `email` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `lastname` IS NULL) OR (`lastname` = ?)) AND ((? = 1 AND `birthday` IS NULL) OR (`birthday` = ?)) AND ((? = 1 AND `gender` IS NULL) OR (`gender` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, lastname, birthday, gender, email FROM employees";
        ...
        public virtual int Delete(int Original_Id, string Original_lastname, string Original_birthday, string Original_gender, string Original_email) {
        ...
        public virtual int Insert(string lastname, string birthday, string gender, string email) {
            if ((lastname == null)) {
        ...
        public virtual int Update(string lastname, string birthday, string gender, string email, int Original_Id, string Original_lastname, string Original_birthday, string Original_gender, string Original_email) {
            if ((lastname == null)) {
    ...
    public partial class phonesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `phones` WHERE ((`Id` = ?) AND ((? = 1 AND `number` IS NULL) OR (`num" +
                "ber` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Id", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Id", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `phones` (`number`) VALUES (?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `phones` SET `number` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `number` IS NU" +
                "LL) OR (`number` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, [number] FROM phones";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(employeesDBDataSet.phonesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual employeesDBDataSet.phonesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            employeesDBDataSet.phonesDataTable dataTable = new employeesDBDataSet.phonesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(employeesDBDataSet.phonesDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
